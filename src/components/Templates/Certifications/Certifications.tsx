...
const certificationsData = [
  {
    ...
    credentialId: '',
    certificateUrl: 'https://kluniversityin-my.sharepoint.com/:b:/g/personal/2200080037_kluniversity_in/Edb_lcvGYH9Nu-IIjFE6SuQB6POMd9Dm3oCZvGvMrdrimA?e=8yho5f',
    image: '/oracle1.png'
  },
  {
    id: 2,
    ...
    certificateUrl: 'https://kluniversityin-my.sharepoint.com/:b:/g/personal/2200080037_kluniversity_in/EdkJ4I3YpMJBrKWet5wM_YgBRkmZxDtgynUvTfsHcPPS6g?e=nYqDs2',
  ...
  },
  {
    ...
    expiryDate: '',
    credentialId: '',
    certificateUrl: 'https://kluniversityin-my.sharepoint.com/:b:/g/personal/2200080037_kluniversity_in/EQKMEvNBQ9tFhtp7B-l_OskBkkd2OzFV0XEBRyNpJv34wg?e=e8o4WT',
    image: '/ibm.png',
  ...
  },
  {
    ...
    credentialId: '',
    certificateUrl: 'https://kluniversityin-my.sharepoint.com/:b:/g/personal/2200080037_kluniversity_in/EbiCZSKvkSNIh4cqls0BhGABSr5qvBjep51bk5WqQdZxaw?e=bnH1fh',
    image: '/oracleGAI.png'
  },
  {
    id: 5,
    ...
    expiryDate: '13-Jul-2026',
    credentialId: '',
    certificateUrl: 'https://kluniversityin-my.sharepoint.com/:b:/g/personal/2200080037_kluniversity_in/EQipcwZmM8FNhb36GvAscfwB7khdOMgI5W87rLTgAqpEZQ?e=7mve5S',
    image: '/OracleAi.png'
  }
];
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 h-full transition-all duration-300 hover:bg-white/15 hover:border-accent/50 text-center">
              ...
              <div className="text-xs text-white/80 mb-3 space-y-1">
                ...
                <p><strong>Earned:</strong> {cert.earnedDate}</p>
                {cert.expiryDate && (
